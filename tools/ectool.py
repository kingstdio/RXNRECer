'''
Author: Zhenkun Shi
Date: 2023-06-25 10:39:42
LastEditors: Zhenkun Shi
LastEditTime: 2023-06-25 10:45:27
FilePath: /preaction/tools/ectool.py
Description: 
...
def convert_DF_dateTime(inputdf):
    ...
    inputdf.date_sequence_update = pd.to_datetime(inputdf['date_sequence_update'], format='%d-%b-%Y')
    inputdf.date_annotation_update = pd.to_datetime(inputdf['date_annotation_update'], format='%d-%b-%Y')
